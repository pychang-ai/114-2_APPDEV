...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            String defaultPort = intent.getStringExtra("DEFAULT_PORT");
            String shipName    = intent.getStringExtra("SHIP_NAME");
            String port        = intent.getStringExtra("PORT");
            String status      = intent.getStringExtra("STATUS");

            if (shipName != null) etShipName.setText(shipName);
            if (port != null) {
                etPort.setText(port);
